...
plot_dat %>% 
  ...
  labs(x = "Tide", y = "Frequency of Sighting", 
       ...
       title = "Sspecies with significantly different presence at low vs. high tide",
       caption = "only species with p < 0.01, chi-squared test")
...
## Aramburu
```{r}
focal_species <- c("American Wigeon", "Caspian Tern", "Elegant Tern", "Least Sandpiper", "Spotted Sandpiper", "Marbled Godwit", "Long-billed Curlew", "Black-necked Stilt", "American Coot", "Western Sandpiper", "Double-crested Cormorant", "Black Oystercatcher")
...
focal_counts <- dat %>% 
  ...
  group_by(year_no, island, tide_hl, common) %>% 
...
focal_counts %>% 
  ...
  labs(x = "Year", y = "fraction of surveys", title = "Aramburu: Frequency of Each Species Being Present")
```
...
## Pickleweed
```{r}
focal_species <- c("American Wigeon", "Caspian Tern", "Elegant Tern", "Least Sandpiper", "Spotted Sandpiper", "Marbled Godwit", "Long-billed Curlew", "Black-necked Stilt", "American Coot", "Western Sandpiper", "Double-crested Cormorant", "Dunlin", "Black Oystercatcher")
...
focal_counts_pi %>% 
  ...
  theme_bw() +
  theme(legend.position = "none") +
  labs(x = "Year", y = "fraction of surveys", title = "Pickleweed: Frequency of Each Species Being Present")
```
...
focal_counts_pi %>% 
  ...
  theme_bw() +
  theme(legend.position = "right") +
  labs(x = "Year", y = "number of individuals", title = "Pickleweed: Average Number of Individuals Present")
```

## usage of different habitat
```{r}
...
focal_species_habitat %>% 
  ...
  scale_y_continuous(breaks = c(0,1)) +
  labs(x = "Before/After Restoration", y = "frequency on habitat", title = "Aramburu: Fractional Use of Habitat Before vs. After Restoration")
```
